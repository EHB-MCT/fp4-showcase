...
export default function EditProfile() {
    ...
    useEffect(() => {
        async function fetchData() {
            const list = await getProjectsByUserID(id);
            setProjects(list);
        }
        fetchData();
    }, [id]);
        ...
        <>
                ...
                <div className=" grid max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 container md:flex-row items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div className="pl-2">
                            ...
                            <span className="text-sm">Multimedia & Creative Technologie - Jaar 2</span>
                        </div>
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="about-me">
                    <h1 className="py-6 text-3xl font-bold mb-4 text-gray-800 flex items-center">About Me</h1>
                    <p className={`initial-text h-10 overflow-hidden ${expanded ? 'h-auto' : ''}`}>
                        A long description is a way to provide long alternative text for non-text elements, such as images. Generally, alternative text
                        exceeding 250 characters, which cannot be made more concise without making it less descriptive or meaningful, should have a long
                        description. Examples of suitable use of long descriptions are charts, graphs, maps, infographics, and other complex images. As with
                        alternative text, long descriptions should be descriptive and meaningful. It should also include all text that is incorporated into the
                        image. A long description should provide visually impaired users with as much information as sighted users would understand from the
                        image.
                    </p>
                    {expanded && <aside className="h-5 bg-white opacity-40 mt-0px" />}
                    {!expanded && <div className="h-5 bg-white opacity-80 mt-[-14px]" />}
                    <div className="flex justify-center" onClick={toggleExpand}>
                        <button className="underline">{expanded ? 'Read less' : 'Read more'}</button>
                    </div>
                </div>
                <div>
                    ...
                    <div className="w-full rounded overflow-hidden shadow-lg bg-white relative">
                        ...
                        <div className="px-6 py-4">
                            ...
                            <div className="flex flex-wrap mt-2">
                                {tags.map((tag) => (
                                    <span key={tag} className="mr-2 mb-2 px-2 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm">
                                        {tag}
                                    </span>
                                ))}
                            </div>
