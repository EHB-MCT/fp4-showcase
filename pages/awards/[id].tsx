        ...
        const fetchAllProjects = async () => {
            try {
                ...
                if (winner) {
                    ...
                    const winnerProject = projects.find((project) => project.project_id === winner.project_id);
                ...
                <div className="containerWidth">
                    ...
                    <div>
                        <div className="flex flex-col">
                            {winner && hasAwardEnded && userData.role === 'admin' && currentDate < localDateOptions.winnerAnnouncement && (
                                <div>
                                    <h1>Award Winner</h1>
                                    <div className=" mt-5 mb-5 ">{winner && <ProjectCard project={winner} />}</div>
                                </div>
                            )}
                            {winner && hasAwardEnded && currentDate > localDateOptions.winnerAnnouncement && (
                                <div>
                                    <h1>Public Winner</h1>
                                    <div className=" mt-5 mb-5 ">{winner && <ProjectCard project={winner} />}</div>
                                </div>
                        ...
                        <div className={`${styles.awardProjects} flex flex-col`}>
                            {currentDate < localDateOptions.adminVoteDeadline && userData && userData.role === 'admin' && (
                                <div className="">
                            ...
                            <div className="flex gap-5">
                                ...
                                {userData && userData.role === 'student' && currentDate < localDateOptions.participateDeadline && !hasParticipated && (
