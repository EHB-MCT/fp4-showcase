...
export default function Project() {
  ...
  return (
    <>
      ...
      {showUnderConstruction && ( // Render the pop-up when showUnderConstruction is true
        <div className="flex items-center justify-center h-screen" style={{marginTop: "14rem"}}>
          <div className="bg-black bg-opacity-50 p-4 rounded shadow-lg h-5">
            <h2>Under Construction</h2>
            <p>The project details page is currently under construction. Please check back later.</p>
          </div>
        </div>
      )}
      { project != null && !showUnderConstruction &&  (
        <>
