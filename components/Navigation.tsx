        ...
        if (username) {
                    ...
                    {isOpen && (
                        <div className={style.dropdown_wrapper}>
                            ...
                            <Link href="/projects/upload">
                                <a className={currentRoute === '/register' ? `${style.active}` : ''} onClick={toggleDropdown}>
                                    Add Project
                                </a>
                            </Link>
                            <Link href="/register">
            ...
            return (
                <div className={style.register}>
                    <Link href="/register">
                        <a className={currentRoute === '/register' ? `${style.active}` : ``}>Sign Up</a>
                    </Link>
                </div>
            );
        }
    ...
    return (
        <>
            <div className={`${style.navigation} max-w-7xl mx-auto px-4 sm:px-6 lg:px-8`}>
                <Link href="/">
                    <svg className={style.logo} xmlns="http://www.w3.org/2000/svg" width="111.443" height="61.413" viewBox="0 0 111.443 61.413">
                        <path
                            id="Path_1253"
                            data-name="Path 1253"
                ...
                <div className={style.links}>
                    ...
                    <Link href="/">
                        <a className={currentRoute === '/' ? `${style.active}` : ''}>Home</a>
                    </Link>
                    <Link href="/awards">
                        <a className={currentRoute === '/awards' ? `${style.active}` : ''}>Awards</a>
                    </Link>
                    <Link href="/about">
                        <a className={currentRoute === '/about' ? `${style.active}` : ''}>About</a>
                    </Link>
                    {renderLoggedInState()}
                </div>
            </div>
