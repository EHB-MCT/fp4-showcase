    ...
    return (
        <>
            <div className="flex flex-col relative">
                <form onSubmit={onSubmit} className="w-2/2 flex flex-col gap-3 pt-5 pl-10 pr-10 pb-4 rounded-md mb-3 mt-5 border-2 border-purple-500">
                    {mode === 'register' ? (
                    ...
                    <div className="flex justify-between">
                        {mode === 'login' ? (
                            <small className="cursor-pointer underline" onClick={handleButtonClick}>
                                Forgot password?
                            </small>
                        ) : (
                            <div></div>
                ...
                <AnimatePresence>
                    {errorMessage && (
                        ...
                        >
                            <span className="text-red-500 border-solid border-2 border-red-600 p-4 rounded-sm">{errorMessage}</span>
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
