...
import { registerUser, loginUser, passwordReset } from "../lib/auth";
...
const ResetForm = () => {
  ...
  return (
    <>
      {emailMessage ? <div className="w-2/2 flex flex-col gap-4 items-cente p-5 rounded-xl mb-5 mt-5 border-2 border-purple-500"
     > 
