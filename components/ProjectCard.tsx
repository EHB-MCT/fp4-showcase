    ...
    if (!project) return null;
        ...
        return (
            <div className={`${styles.projectCardWrapper} ${styles.neonEffect}`}>
                <motion.div className={`${styles.projectCardWrapper} ${styles.neonEffect}`} variants={staggerVariant} initial="hidden" animate="visible">
                    <div
                        onClick={() => {
                        ...
                        <div className={styles.projectCardInformationContainer}>
                            ...
                            <div className={styles.projectCardInformationSubContainer}>
                                <div className={styles.projectCardInformationTitleContainer}>
                                    <a href={`/profile/${project.uid}`} key={project.uid} className={styles.a_wrapper}>
                                    ...
                                    <a href={`/projects/${project.project_id}`} key={project.id} className={styles.a_wrapper}>
                                        <p className={styles.projectCardInformationTitle}>{project.title}</p>
                                    </a>
                                </div>
                                {/* 
                // LIKE BUTTON
